...
print(f"rKL of test ranking is  {str(fair_rKL)}")
print(f"rND of test ranking is  {str(fair_rND)}")
print(f"rKL of test ranking is  {str(fair_rRD)}")
...
print (f"score difference between input two scores lists is  {str(acc_scoreDiff)}")
print (f"position difference between input two permutations is {str(acc_posDiff)}")
print (f"kendall distance between input two permutations is  {str(acc_kendallDis)}")
print (f"spearman distance between input two scores lists is  {str(acc_spearmanDis)}")
print (f"pearson correlation between input two scores lists is  {str(acc_pearsonDis)}")
